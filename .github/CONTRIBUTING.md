...
VaultKind is permanently English-only. Do not submit translation bundles, language selectors, right-to-left layout machinery, or requests to use Cryptomator's translation service on VaultKind's behalf.
