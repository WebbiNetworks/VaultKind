...
[
    ("permanent profile", () => VaultKindDataPaths.ResolveLocalApplicationDataRoot("C:\\Users\\ExampleUser\\AppData\\Local", null), "C:\\Users\\ExampleUser\\AppData\\Local"),
    ("development package profile", () => VaultKindDataPaths.ResolveLocalApplicationDataRoot("C:\\Users\\ExampleUser\\AppData\\Local", "LocalMsix.WebDav"), "C:\\Users\\ExampleUser\\AppData\\Local\\VKP\\LocalMsix.WebDav"),
    ("Store package profile", () => VaultKindDataPaths.ResolveLocalApplicationDataRoot("C:\\Users\\ExampleUser\\AppData\\Local", "Store"), "C:\\Users\\ExampleUser\\AppData\\Local\\VKP\\Store")
];
...
string isolatedBridgePath = VaultKindDataPaths.ResolveSocketPath(
    "C:\\Users\\ExampleUser\\AppData\\Local\\VKP\\LocalMsix.WebDav",
    "LocalMsix.WebDav",
    "C:\\Users\\ExampleUser");
if (!isolatedBridgePath.Equals("C:\\Users\\ExampleUser\\.vaultkind-runtime\\LocalMsix.WebDav\\native-bridge-v1.sock", StringComparison.OrdinalIgnoreCase))
{
...
foreach (string invalidProfileId in new[] { "..", ".leading", "slash/profile", "backslash\\profile", new string('a', 17) })
{
    try
    {
        VaultKindDataPaths.ResolveLocalApplicationDataRoot("C:\\Users\\ExampleUser\\AppData\\Local", invalidProfileId);
...
string persistentSettingsPath = JavaVaultEngineHost.ResolvePersistentSettingsPath(Path.Combine("C:\\", "Users", "ExampleUser", "AppData", "Local"));
string expectedPersistentSettingsPath = Path.Combine("C:\\", "Users", "ExampleUser", "AppData", "Local", "VaultKind", "engine", "settings.json");
